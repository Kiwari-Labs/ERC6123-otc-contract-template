...
library StringBytes {
    function parseHexStringToBytes(string memory input) public pure returns (bytes memory result) {
        assembly {
            ...
            function fromHexChar(c) -> nibble {
                switch c
                case 0x30 /*'0'*/ { nibble := 0 }
                case 0x31 /*'1'*/ { nibble := 1 }
                case 0x32 /*'2'*/ { nibble := 2 }
                case 0x33 /*'3'*/ { nibble := 3 }
                case 0x34 /*'4'*/ { nibble := 4 }
                case 0x35 /*'5'*/ { nibble := 5 }
                case 0x36 /*'6'*/ { nibble := 6 }
                case 0x37 /*'7'*/ { nibble := 7 }
                case 0x38 /*'8'*/ { nibble := 8 }
                case 0x39 /*'9'*/ { nibble := 9 }
                case 0x61 /*'a'*/ { nibble := 10 }
                case 0x62 /*'b'*/ { nibble := 11 }
                case 0x63 /*'c'*/ { nibble := 12 }
                case 0x64 /*'d'*/ { nibble := 13 }
                case 0x65 /*'e'*/ { nibble := 14 }
                case 0x66 /*'f'*/ { nibble := 15 }
                default {
                    revert(0, 0)
                }
            }
